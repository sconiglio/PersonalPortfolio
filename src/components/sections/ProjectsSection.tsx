  ...
  all: [
    {
      ...
      description:
        "Led the redesign of a major e-commerce platform, improving user experience and increasing conversion rates by 25%. Implemented A/B testing strategies and user research to drive data-driven decisions.",
    ...
    },
    {
      ...
      description:
        "Successfully launched a key feature for a mobile application, resulting in 30% increase in user retention and positive user feedback. Managed the entire product lifecycle from ideation to launch.",
      image: "/logos/project_logo.png",
      tags: ["Mobile", "Product Management", "User Research", "Launch"],
      link: "https://example.com",
      linkText: "View Project",
      linkIcon: "external" as const,
    },
    {
      ...
      description:
        "Analyzed and optimized internal business processes, reducing operational costs by 20% and improving efficiency through automation and process redesign.",
      image: "/logos/project_logo.png",
      tags: [
        "Process Improvement",
        "Automation",
    ...
    },
    {
      ...
      description:
        "Developed a comprehensive analytics dashboard that provided insights into customer behavior and business metrics, enabling data-driven decision making across the organization.",
      image: "/logos/project_logo.png",
      tags: [
        "Analytics",
        "Dashboard",
