...
const timelineData: TimelineEvent[] = [
  // Education
  {
    ...
    logo: "/logos/university_logo.png",
    details: [
      "Learned to bridge the gap between business needs and technology to create meaningful change.",
      "Relevant Coursework: Product Management, Entrepreneurship, Agile Methods, Data Analytics, Business Strategy",
      "Awards: Dean's List, Business Innovation Award (GPA 3.5)",
    ],
  },
  {
    type: "education",
    ...
    logo: "/logos/university_logo.png",
    details: [
      "Developed strong foundation in business principles and strategic thinking.",
      "Relevant Coursework: Marketing, Finance, Operations Management, Business Analytics, Strategic Management",
      "Awards: Dean's List, Academic Excellence Award (GPA 3.6)",
    ],
  },
  {
    type: "education",
    ...
    logo: "/logos/high_school_logo.png",
    details: [
      "Developed leadership skills through various extracurricular activities and community service.",
      "Founded Business Club - 100+ members, organized events and workshops",
      "Volunteer work - Organized community service events and fundraisers",
    ],
  },
  // Experience (Most Recent First)
  {
    ...
    category: "product",
    bullets: [
      "Led product strategy for key features, improving user engagement by 25% and driving business metrics",
      "Managed cross-functional teams of 8+ engineers, designers, and analysts to deliver successful product launches",
      "Conducted user research and A/B testing to optimize product performance and user experience",
      "Collaborated with stakeholders across the organization to align product roadmap with business objectives",
    ],
  },
  {
    type: "experience",
    ...
    category: "product",
    bullets: [
      "Owned product roadmap for core features, growing user engagement by 30% through data-driven decisions",
      "Created and executed go-to-market strategies for new product launches",
      "Improved user retention by 20% by running A/B tests and incorporating user feedback into feature releases",
    ],
  },
  {
    type: "experience",
    ...
    category: "product",
    bullets: [
      "Assisted in product strategy development and feature prioritization for web applications",
      "Conducted user research and competitive analysis to inform product decisions",
      "Supported product launches and helped optimize user experience through data analysis",
    ],
  },
  {
    type: "experience",
